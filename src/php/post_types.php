...
function cptui_register_my_cpts() {
	...
	$labels = [
		"name" => esc_html__( "주문 관리", "hanmi-academy" ),
		"singular_name" => esc_html__( "주문", "hanmi-academy" ),
	];

	$args = [
		"label" => esc_html__( "주문 관리", "hanmi-academy" ),
		"labels" => $labels,
		"description" => "",
		"public" => false,
		...
		"rewrite" => false,
		"query_var" => false,
		"supports" => [ "title", "author", "date" ],
		"show_in_graphql" => false,
	];

	register_post_type( "post_order", $args );
}
